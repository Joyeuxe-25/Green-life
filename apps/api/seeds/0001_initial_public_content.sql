...
('cb-home-hero', 'home', 'hero', 'hero', 'Green for Life Rwanda', 'Community action for people and nature', 'Sustainable agroforestry, ecosystem restoration, and resilient livelihoods across Rwanda.', 'Green for Life Rwanda works with communities to restore ecosystems, improve food security, and strengthen livelihoods through practical agroforestry solutions.', 'Green for Life Rwanda is a community-based Rwandan non-profit organization focused on environmental protection, sustainable agroforestry, and livelihood improvement for small-scale farmers, women, youth, and vulnerable communities.', 'Explore programs', '/programs', 'Support our work', '/donate', '/public/media/file/enhanced-community-seedling-training', 1, 'published', datetime('now'), datetime('now')),
('cb-home-mission', 'home', 'mission-preview', 'section', 'Our mission', 'Protecting the environment while improving livelihoods', NULL, 'GLR promotes sustainable agroforestry practices with communities across Rwanda.', 'Green for Life Rwanda protects the environment and improves the livelihoods of small-scale farmers by promoting sustainable agroforestry practices in communities across Rwanda.', 'About GLR', '/about', 'View impact', '/impact', '/public/media/file/enhanced-tree-nursery-landscape', 2, 'published', datetime('now'), datetime('now')),
('cb-home-cta', 'home', 'support-cta', 'cta', 'Get involved', 'Help communities restore land and grow resilient livelihoods', NULL, 'Support farmer training, tree planting, school greening, and community-led restoration work.', 'Your support helps Green for Life Rwanda expand practical climate and livelihood solutions with smallholder farmers, women, youth, and vulnerable communities.', 'Donate', '/donate', 'Contact us', '/contact', '/public/media/file/enhanced-fruit-tree-plantation', 9, 'published', datetime('now'), datetime('now')),

('cb-about-who-we-are', 'about', 'who-we-are', 'section', 'Who we are', 'A community-based organization rooted in practical local solutions', NULL, 'GLR works closely with smallholder farmers, women, and youth to address climate change, food insecurity, and poverty.', 'Green for Life Rwanda is a community-based non-profit committed to environmental protection and sustainable livelihood improvement for vulnerable populations. The organization works closely with smallholder farmers, women, and youth through practical local solutions addressing climate change, food insecurity, and poverty.', 'See programs', '/programs', NULL, NULL, NULL, 1, 'draft', datetime('now'), datetime('now')),
('cb-about-mission', 'about', 'mission', 'section', 'Mission', 'Protect the environment and improve livelihoods', NULL, 'Green for Life Rwanda promotes sustainable agroforestry practices in communities across Rwanda.', 'Green for Life Rwanda''s mission is to protect the environment and improve the livelihoods of small-scale farmers by promoting sustainable agroforestry practices in communities across Rwanda.', NULL, NULL, NULL, NULL, '/public/media/file/enhanced-tree-nursery-landscape', 2, 'published', datetime('now'), datetime('now')),
...
('partner-world-connect', 'World Connect', 'world-connect', 'https://worldconnect-us.org/power-center/rwanda', 'Green for Life Rwanda partner.', 1, 'active', 0, datetime('now'), datetime('now'), NULL),
('partner-biocoor', 'Biocoor', 'biocoor', 'https://biocoor.org.rw/', 'Green for Life Rwanda partner.', 2, 'active', 0, datetime('now'), datetime('now'), NULL),
('partner-segal-family-foundation', 'Segal Family Foundation', 'segal-family-foundation', 'https://www.segalfamilyfoundation.org/', 'Green for Life Rwanda partner.', 3, 'active', 0, datetime('now'), datetime('now'), NULL),
('partner-rgb', 'RGB', 'rgb', 'https://www.rgb.rw/', 'Green for Life Rwanda partner.', 4, 'active', 0, datetime('now'), datetime('now'), NULL),
('partner-bridge-of-hope', 'Bridge of Hope', 'bridge-of-hope', 'https://bridgeofhope.org.rw/', 'Green for Life Rwanda partner.', 5, 'active', 0, datetime('now'), datetime('now'), NULL),
('partner-fmi-ubumuntu', 'FMI Ubumuntu', 'fmi-ubumuntu', 'https://www.friendsofmotherland.org/', 'Green for Life Rwanda partner.', 6, 'active', 0, datetime('now'), datetime('now'), NULL),
('partner-restore-local', 'Restore Local', 'restore-local', 'https://restorelocal.org/', 'Green for Life Rwanda partner.', 7, 'active', 0, datetime('now'), datetime('now'), NULL)
ON CONFLICT(id) DO UPDATE SET
  name = excluded.name,
  slug = excluded.slug,
...
('site.name', 'general', 'Site name', 'Green for Life Rwanda', 'text', datetime('now')),
