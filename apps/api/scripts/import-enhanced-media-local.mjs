...
const sqlPath = path.join(os.tmpdir(), "green-life-rwanda-enhanced-media-local.sql");
...
console.log(`Imported ${rows.length} enhanced AVIF media files into local R2/D1.`);
console.log(`Public preview URLs use ${API_BASE_URL}/public/media/file/:id`);
...
WHERE page_key = 'about' AND block_key = 'who-we-are';
`;
}
